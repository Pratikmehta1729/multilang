...
const mongoConnectionURL =
  "mongodb+srv://rishav:helloworld@cluster0-1zq8a.mongodb.net/code?retryWrites=true&w=majority";
...
app.post("/uploadCode", async (req, res) => {
  ...
  const result = await codeSchema.updateOne(
    { id: id },
    { $set: { code: code, lang: lang, varObj: vars } },
    { upsert: true }
  );
  res.send(result);
});
